...
public class NoPOMTest99GuruLogin {
	...
	public void test_Home_Page_Appear_Correct(){
	    ...
	    driver.findElement(By.name("uid")).sendKeys("mngr104098");
	    //find password and fill it
	    driver.findElement(By.name("password")).sendKeys("zUtyrYn");
	    //click login button
	    driver.findElement(By.name("btnLogin")).click(); 
	    String homeText = driver.findElement(By.xpath("//table//tr[@class='heading3']")).getText();
	    //verify login success
		Assert.assertTrue(homeText.toLowerCase().contains("mngr104098"));
		driver.quit();
	}
